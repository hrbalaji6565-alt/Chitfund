...
const links: SidebarLinkWithChildren[] = [
    ...
    { href: "/admin/chit-adjustments", label: "Chit Adjustments", icon: <SlidersHorizontal size={16} /> },
    ...
    { 
      ...
      icon: <Wallet size={16} />,
      children: [
        { href: "/admin/loan/create", label: "Loan Create", icon: <Wallet size={14} /> },
        { href: "/admin/loan/list", label: "Loan List", icon: <FileText size={14} /> },
        { href: "/admin/loan/transaction", label: "Loan Transaction", icon: <FileText size={14} /> },
      ]
    },
              ...
              {item.children ? (
                <div>
                  ...
                  >
                    ...
                    <span className="opacity-70">{/* caret */}
